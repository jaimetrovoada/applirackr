...
export default function Page() {
  ...
  return (
    <main className="container mx-auto flex flex-1 flex-col items-center justify-center gap-4 p-4 lg:px-0">
      <div className="min-h-1/3 mx-auto flex w-full max-w-screen-sm flex-col items-center gap-6 rounded-lg border border-gray-600/50 bg-zinc-950 p-4 shadow-md">
